...
Expected response is a CBOR-encoded status object. A 200 response confirms the gateway is reachable and the subnet hosting canister `gny6k-fqaaa-aaaab-ag3ra-cai` is accessible.
