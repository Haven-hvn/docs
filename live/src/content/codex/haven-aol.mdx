---
title: haven-aol — keys and access
...
`haven-aol` is canister `gny6k-fqaaa-aaaab-ag3ra-cai` on ICP mainnet. It is written in Motoko and exposes a Candid interface — ten methods, no more. Its boundary is unusually narrow:
